        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        <div class="sidebar-profile-image">
                            <img src="data:image/jpge;base64,<?php echo base64_encode($user[0]->foto);?>" class="circle" alt="">
                        </div>
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">apps</i>Gestión Personas<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="mailbox.html">Módulo Perfil</a></li>
                                <li><a href="search.html">Módulo Cliente</a></li>
                                <li><a href="todo.html">Módulo Usuario</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
